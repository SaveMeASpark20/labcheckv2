                 ...
                 while ($row = $result->fetch_assoc()): ?>
                    ...
                    <tr>
                        ...
                        <td data-cell="Action">
                            ...
                            <form action="../includes/process_request_equipment.php" method="post" class="approval-form">
                                <input type="hidden" name="request_id" value="<?php echo $row['request_id']; ?>">
                                <button type="submit" onclick="return confirmApproval()" name="approve">Approve</button>
                            </form>

                            <form action="../includes/process_request_equipment.php" method="post" class="rejection-form">
                                <input type="hidden" name="request_id" value="<?php echo $row['request_id']; ?>">
...
<div id="rejectionModal" class="modal">
    <div class="modal-content">
        ...
        <form action="../includes/process_request_equipment.php" method="POST" class="modal-rejection-form">
